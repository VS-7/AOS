...
export const TASK_STATUS_CONFIG: Record<FractalTask["status"], { label: string; icon: any; color: string; defaultOpen?: boolean }> = {
...
export const TASK_PRIORITY_CONFIG: Record<FractalTaskPriority, { label: string; icon: any; colorClass: string }> = {
...
export const TASK_STATUS_ORDER: FractalTask["status"][] = ["suggestion", "backlog", "planning", "todo", "in_progress", "stopped", "in_review", "finished"];
export const TASK_PRIORITY_ORDER: FractalTaskPriority[] = ["no_priority", "urgent", "high", "medium", "low"];
